...
export function organizationSchema(): JsonLd {
  return {
    ...
    sameAs: ['https://www.instagram.com/shopiafr', 'https://www.facebook.com/shopiafr'],
    contactPoint: [{ '@type': 'ContactPoint', contactType: 'customer support', email: 'support@shop-ia.fr', availableLanguage: ['fr', 'en'] }],
    knowsAbout: ['Épicerie fine', 'Produits alimentaires', 'Circuits courts', 'Bio', 'Gastronomie'],
  };
}
...
export function productSchema(product: Product): JsonLd {
  return {
    ...
    additionalProperty: [
      { '@type': 'PropertyValue', name: 'Qualité contrôlée', value: 'Oui' },
      { '@type': 'PropertyValue', name: 'Origine', value: 'France & Europe' },
    ],
  };
}
