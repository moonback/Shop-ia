...
export default function AdminProductsTab({ products, categories, onRefresh }: AdminProductsTabProps) {
    ...
    const handleGenerateFoodProducts = async () => {
        if (!confirm('Voulez-vous générer 20 produits alimentaires complets ? Cette opération va ajouter des produits variés à votre base de données.')) return;

        setIsGeneratingCBD(true);
        setCbdProgress({ done: 0, total: 20 });

        const foodProducts = [
            {
                name: "Pain Artisanal Complet",
                description: "Pain complet au levain naturel, cuit au four à bois. 500g de pur tradition française.",
                nutriscore: "A",
                weight_info: "500g",
                weight_grams: 500,
                price: 3.20,
                ...
                stock_quantity: 25,
                sku: "PAIN-001",
                benefits: ["Riche en fibres", "Sans conservateurs", "Fabrication artisanale"],
                aromas: ["Céréales", "Pain frais", "Naturel"],
            ...
            },
            {
                ...
                description: "Fromage de chèvre frais du Poitou, texture crémeuse et saveur délicate. 150g.",
                nutriscore: "B",
                weight_info: "150g",
                weight_grams: 150,
                price: 4.50,
                ...
                stock_quantity: 18,
                sku: "FROM-001",
                benefits: ["Calcium", "Protéines", "Artisanal"],
                aromas: ["Frais", "Lacté", "Doux"],
                image_url: "https://images.unsplash.com/photo-1585036341725-3d33cab8778c?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: true,
                is_subscribable: false
            },
            {
                name: "Miel de Provence Lavande",
                description: "Miel monofloral de lavande des Alpes de Provence. Récolté manuellement, 250g.",
                nutriscore: "A",
                weight_info: "250g",
                weight_grams: 250,
                price: 8.90,
                ...
                stock_quantity: 30,
                sku: "MIEL-001",
                benefits: ["Antibactérien", "Digestion", "Naturel"],
            ...
            },
            {
                ...
                description: "Jus de pomme pressé à froid, non filtré, sans sucre ajouté. Agriculture biologique. 1L.",
                nutriscore: "A",
                weight_info: "1L",
                weight_grams: 1000,
                price: 4.20,
                ...
                stock_quantity: 40,
                sku: "JUS-001",
                benefits: ["Vitamines", "Antioxydants", "Bio"],
                aromas: ["Pomme", "Fruité", "Frais"],
                image_url: "https://images.unsplash.com/photo-1621263760928-aea9b5414381?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: true,
                is_subscribable: true
            },
            {
                ...
                description: "Huile d'olive AOP Nyons, première pression à froid. Saveur fruitée verte. 500ml.",
                nutriscore: "A",
                weight_info: "500ml",
                weight_grams: 500,
                price: 12.90,
                ...
                stock_quantity: 22,
                sku: "HUILE-001",
                benefits: ["Oméga-3", "Antioxydants", "AOP"],
                aromas: ["Olive", "Fruité", "Herbacé"],
            ...
            },
            {
                ...
                description: "Confiture artisanale de fraises, framboises et cerises. 70% de fruits. 370g.",
                nutriscore: "B",
                weight_info: "370g",
                weight_grams: 370,
                price: 5.40,
                ...
                stock_quantity: 35,
                sku: "CONF-001",
                benefits: ["Fruits rouges", "Vitamine C", "Artisanal"],
                aromas: ["Fraises", "Framboises", "Sucré"],
                image_url: "https://images.unsplash.com/photo-1528236238844-9117b77b49be?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: true,
                is_subscribable: true
            },
            {
                ...
                description: "Pâtes fraîches aux œufs fermiers, fabrication traditionnelle italienne. 250g.",
                nutriscore: "B",
                weight_info: "250g",
                weight_grams: 250,
                price: 4.80,
                ...
                stock_quantity: 45,
                sku: "PATES-001",
                benefits: ["Œufs fermiers", "Farine locale", "Tradition"],
                aromas: ["Blé", "Œuf", "Naturel"],
                image_url: "https://images.unsplash.com/photo-1586238397499-142fd8426356?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: false,
                is_subscribable: false
            },
            {
                ...
                description: "Saumon atlantique fumé au bois de hêtre, tranché main. 200g.",
                nutriscore: "B",
                weight_info: "200g",
                weight_grams: 200,
                price: 8.90,
                ...
                stock_quantity: 15,
                sku: "SAUM-001",
                benefits: ["Oméga-3", "Protéines", "Fumaison bois"],
                aromas: ["Fumé", "Poisson", "Salé"],
                image_url: "https://images.unsplash.com/photo-1467003909585-2f1a4273d087?auto=format&fit=crop&q=80&w=400",
                is_featured: true,
                is_available: true,
                is_subscribable: false
            },
            {
                name: "Chocolat Noir 72% Cacao",
                description: "Tablette de chocolat noir origine Pérou, 72% cacao. Bio et équitable. 100g.",
                nutriscore: "C",
                weight_info: "100g",
                weight_grams: 100,
                price: 3.90,
                ...
                stock_quantity: 50,
                sku: "CHOC-001",
                benefits: ["Antioxydants", "Magnésium", "Équitable"],
                aromas: ["Cacao", "Amer", "Intense"],
                image_url: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: true,
                is_subscribable: true
            },
            {
                ...
                description: "Yaourt nature au lait entier de vaches locales. Fermentation lactique naturelle. 4x125g.",
                nutriscore: "A",
                weight_info: "500g",
                weight_grams: 500,
                price: 2.90,
                ...
                stock_quantity: 28,
                sku: "YAOU-001",
                benefits: ["Probiotiques", "Calcium", "Lait fermier"],
                aromas: ["Lait", "Doux", "Frais"],
            ...
            },
            {
                ...
                description: "Noix fraîches du Périgord, récoltée manuellement. Saveur douce et beurrée. 250g.",
                nutriscore: "A",
                weight_info: "250g",
                weight_grams: 250,
                price: 6.20,
                ...
                sku: "NOIX-001",
                benefits: ["Oméga-3", "Antioxydants", "AOP"],
                aromas: ["Noisette", "Beurré", "Naturel"],
                image_url: "https://images.unsplash.com/photo-1596007530964-c95f0b6f3b0c?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: false,
                is_subscribable: false
            },
            {
                ...
                description: "Miel corsé de châtaignier des Cévennes. Saveur amère et puissante. 250g.",
                nutriscore: "A",
                weight_info: "250g",
                weight_grams: 250,
                price: 7.90,
                ...
                stock_quantity: 25,
                sku: "MIEL-002",
                benefits: ["Minéraux", "Énergie", "Montagne"],
                aromas: ["Châtaignier", "Corsé", "Boisé"],
                image_url: "https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&q=80&w=400&random=1",
                is_featured: false,
                is_available: true,
                is_subscribable: false
            },
            {
                name: "Purée de Tomates Basilic",
                description: "Purée de tomates fraîches et basilic, sans additifs. 500g.",
                nutriscore: "A",
                weight_info: "500g",
                weight_grams: 500,
                price: 3.40,
                ...
                stock_quantity: 38,
                sku: "TOMATE-001",
                benefits: ["Lycopène", "Vitamines", "Basilic"],
                aromas: ["Tomate", "Basilic", "Frais"],
                image_url: "https://images.unsplash.com/photo-1592924357228-1a92b2c99e6e?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: true,
                is_subscribable: false
            },
            {
                name: "Fromage Comté 24 Mois",
                description: "Comté AOP affiné 24 mois, saveurs complexes de noisette et fruit. 200g.",
                nutriscore: "B",
                weight_info: "200g",
                weight_grams: 200,
                price: 6.80,
                ...
                stock_quantity: 16,
                sku: "COMTE-001",
                benefits: ["Calcium", "Protéines", "AOP"],
                aromas: ["Noisette", "Fruit", "Fromage"],
                image_url: "https://images.unsplash.com/photo-1585237557448-4db48a8b21b1?auto=format&fit=crop&q=80&w=400",
                is_featured: true,
                is_available: true,
                is_subscribable: false
            },
            {
                name: "Thé Vert Sencha Japon",
                description: "Thé vert sencha de première récolte, Kyoto. Saveur végétale et iodée. 100g.",
                nutriscore: "A",
                weight_info: "100g",
                weight_grams: 100,
                price: 9.90,
                ...
                stock_quantity: 32,
                sku: "THE-001",
                benefits: ["Antioxydants", "Théine", "Japon"],
                aromas: ["Végétal", "Iodé", "Frais"],
                image_url: "https://images.unsplash.com/photo-1576092768244-dec231e797a9?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: true,
                is_subscribable: true
            },
            {
                name: "Jambon Cru de Bayonne",
                description: "Jambon de Bayonne AOP, sel de l'Adour, affinage 12 mois. 150g.",
                nutriscore: "B",
                weight_info: "150g",
                weight_grams: 150,
                price: 5.90,
                ...
                stock_quantity: 22,
                sku: "JAMBON-001",
                benefits: ["Protéines", "AOP", "Tradition"],
                aromas: ["Salé", "Cuit", "Porc"],
                image_url: "https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?auto=format&fit=crop&q=80&w=400",
                is_featured: false,
                is_available: false,
                is_subscribable: false
            },
            {
                ...
                description: "Sirop d'érable pur du Québec, récolté traditionnellement. 250ml.",
                nutriscore: "B",
                weight_info: "250ml",
                weight_grams: 250,
                price: 8.40,
                ...
                stock_quantity: 18,
                sku: "SIROP-001",
                benefits: ["Naturel", "Minéraux", "Québec"],
                aromas: ["Érable", "Sucré", "Boisé"],
                image_url: "https://images.unsplash.com/photo-1613478327757-4c6a0d1c4a2a?auto=format&fit=crop&q=80&w=400",
                is_featured: true,
                is_available: true,
                is_subscribable: false
            },
            {
                name: "Olives Kalamon Marinées",
                description: "Olives grecques Kalamon marinées à l'huile d'olive et herbes. 200g.",
                nutriscore: "A",
                weight_info: "200g",
                weight_grams: 200,
                price: 4.20,
                ...
                stock_quantity: 40,
                sku: "OLIVE-001",
                benefits: ["Antioxydants", "Gras sains", "Grèce"],
                aromas: ["Salé", "Herbes", "Olive"],
            ...
            },
            {
                ...
                description: "Farine de blé complet moulu sur pierre, type T150. Riche en fibres. 1kg.",
                nutriscore: "A",
                weight_info: "1kg",
                weight_grams: 1000,
                price: 2.80,
                ...
                stock_quantity: 45,
                sku: "FARINE-001",
                benefits: ["Fibres", "Vitamines B", "Moulu pierre"],
                aromas: ["Blé", "Céréales", "Naturel"],
                image_url: "https://images.unsplash.com/photo-1528236238844-9117b77b49be?auto=format&fit=crop&q=80&w=400&random=2",
                is_featured: false,
                is_available: true,
                is_subscribable: true
            },
            {
                ...
                description: "Lait de coco biologique, première pression. Sans additifs ni conservateurs. 400ml.",
                nutriscore: "A",
                weight_info: "400ml",
                weight_grams: 400,
                price: 2.40,
                ...
                stock_quantity: 55,
                sku: "COCO-001",
                benefits: ["Végétalien", "Sans lactose", "Bio"],
                aromas: ["Coco", "Exotique", "Doux"],
        ...
        for (let i = 0; i < foodProducts.length; i++) {
            try {
                ...
                const categoryId = categories.find(c => c.name === "Épicerie")?.id || 
                                 categories.find(c => c.name === "Fromages")?.id || 
                                 categories.find(c => c.name === "Miels et Confitures")?.id || 
                                 categories[0]?.id;
                ...
                console.error(`Erreur lors de la création du produit ${foodProducts[i].name}:`, error);
                failedCount++;
            } finally {
                setCbdProgress({ done: i + 1, total: 20 });
                await sleep(200); // Small delay between insertions
            }
        }

        setIsGeneratingCBD(false);
        setCbdProgress(null);
        onRefresh();

        alert(`Génération terminée: ${successCount} produits créés avec succès, ${failedCount} échecs.`);
    };
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={handleGenerateFoodProducts}
                        disabled={isGeneratingCBD}
                        className="flex items-center gap-2 bg-orange-600 hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-all shadow-lg shadow-orange-600/20 active:scale-95"
                        title="Générer 20 produits alimentaires complets"
                    >
                        <ShoppingBag className={`w-4 h-4 ${isGeneratingCBD ? 'animate-pulse text-green-neon' : 'text-white'}`} />
                        <span>
