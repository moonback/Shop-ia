            ...
            <div className="flex flex-col items-center gap-4">
                ...
                >
                    ...
                    <div className="flex items-start justify-between mb-4 relative z-10">
                        <div>
                            <p className="text-[9px] font-mono tracking-[0.3em] text-green-400/60 uppercase mb-1">Shop-ia</p>
        ...
        <div className="flex flex-col items-center gap-6 w-full">
            ...
            >
                ...
                <div className="flex items-start justify-between mb-6 relative z-10 pt-2">
                    <div>
                        <p className="text-[8px] font-mono tracking-[0.4em] text-green-400/50 uppercase mb-2">Shop-ia CBD</p>
