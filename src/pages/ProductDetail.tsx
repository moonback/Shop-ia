          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-10">
                {product.attributes?.custom_specs && Object.keys(product.attributes.custom_specs).length > 0 && (
                  <div className="space-y-4 w-full">
                    <p className="text-[10px] text-zinc-500 font-black uppercase tracking-[0.2em]">Caractéristiques</p>
                    <div className="grid sm:grid-cols-2 gap-2">
                      {Object.entries(product.attributes.custom_specs as Record<string, unknown>).map(([key, value]) => (
                        <div key={key} className="text-xs bg-white/5 border border-white/10 rounded-xl px-3 py-2">
                          <span className="text-zinc-400 uppercase tracking-wider mr-2">{key}:</span>
